...
let b:fortran_toc           = get(g:, 'fortran_toc_map',        s:leader . 'tt')
let b:fortran_lint          = get(g:, 'fortran_lint_map',       s:leader . 'll')
...
call s:map_buf('n', b:fortran_toc,           '<Plug>(vimf90-toc)')
call s:map_buf('n', b:fortran_lint,          '<Plug>(vimf90-lint)')
...
" Undo ftplugin
let s:undo_vars = 'unlet! b:fortran_compile b:fortran_exe b:fortran_run b:fortran_cla b:fortran_dbg b:fortran_make b:fortran_makeProp b:fortran_fpm_build b:fortran_fpm_run b:fortran_fpm_test b:fortran_fpm_test_cur b:fortran_tags b:fortran_find_mod b:fortran_doc b:fortran_ford_build b:fortran_ford_preview b:fortran_profile b:fortran_openmp b:fortran_mpi b:fortran_gpu b:fortran_mpirun b:fortran_repl_toggle b:fortran_repl_send b:fortran_repl_subprog b:fortran_repl_buffer b:fortran_scratch b:fortran_scratch_run b:fortran_inspect_array b:fortran_break_toggle b:fortran_toc b:fortran_lint'
