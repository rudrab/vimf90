...
" CheckMain: Check if current buffer is the main program
function! CheckMain()
...
" Run: Compile, Link and Run executable
function! Run()
  exe ":cclose"
  exe ":update"
  let sou               = expand("%:p")
...
let b:Rdir = " "
"MakeConf: Autoscan to create configure.scan
function! MakeConf()
