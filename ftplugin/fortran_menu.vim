...
if has('gui_running') && has('menu')
  ...
  if g:Fortran_menumode == 1
    an  Fortran&90.&Project<Tab>\sys                                    :call GenSys()<cr>
    ...
    "an  &Fortran90.&Blocks.&Program<Tab>`prg                            :call Prog("prog")<cr><CR><Esc>gg=G<C-j>
    "an  &Fortran90.&Blocks.&Module<Tab>`mod                             \`mod<CR>
